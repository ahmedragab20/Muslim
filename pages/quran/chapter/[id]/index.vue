...
<script setup lang="ts">
  ...
  // TODO: Settings for the reading mode [text-size, list of reciters, tafsir, translation, etc.]
  ...
  // TODO: individual ayah tafsir: api.quran-tafseer.com/tafseer/{tafseer_id}/{sura_number}/{ayah_number}
  // TODO: individual page for the chapter to have the tafsir under the aya: api.quran-tafseer.com/tafseer/{tafseer_id}/{sura_number}/{ayah_number_from}/{ayah_number_to}
  ...
  // TODO: surah container position should be based on the choice of the user [left, right, center]
</script>
